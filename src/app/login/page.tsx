    ...
    return (
        <div className="flex flex-col min-h-screen bg-[#050506] p-8 pt-24 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center mb-16 animate-in fade-in slide-in-from-top-4 duration-1000">
                ...
                <h1 className="text-3xl font-bold tracking-tight mb-3 text-white italic">Start Your Growth</h1>
                <p className="text-sm text-slate-500 font-medium">로그인하고 압도적인 상담 성과를 만들어보세요.</p>
            </div>
            ...
            <div className="glass-card p-10 rounded-[2.5rem] relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                <form onSubmit={handleLogin} className="flex flex-col gap-6">
                    <div className="space-y-2.5">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full bg-white/[0.03] border border-white/10 rounded-2xl py-5.5 pl-12 pr-4 text-[15px] font-medium focus:outline-none focus:ring-1 focus:ring-primary/40 focus:border-primary/40 transition-all placeholder:text-slate-700 text-white"
                                required
                            />
                        </div>
                    </div>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="mt-6 w-full premium-gradient text-white py-5.5 rounded-2xl font-bold flex items-center justify-center gap-2 shadow-xl shadow-primary/20 btn-hover-effect disabled:opacity-50"
                    >
                ...
                <div className="mt-10 pt-8 border-t border-white/[0.05] text-center">
                    <p className="text-xs text-slate-500 font-medium tracking-tight">
                        ...
                        <Link href="/onboarding" className="text-primary font-bold ml-2 hover:text-primary/80 transition-colors tracking-widest uppercase">Create Free Account</Link>
                    </p>
                </div>
            </div>
